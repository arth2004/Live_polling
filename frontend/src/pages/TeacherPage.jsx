...
export default function TeacherPage({ onAsk }) {
  ...
  const handleSubmit = () => {
    ...
    onAsk({ question, duration, options })
  }
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6">
      ...
      {/* Heading */}
      <h1 className="text-3xl  text-textDark mb-1">Let’s <span className="text-textDark font-bold">Get Started</span></h1>
      ...
      <div className="flex flex-col md:flex-row md:items-start md:space-x-6 mb-8">
        <div className="flex-1">
          <label className="block mb-2 font-medium text-textDark">Enter your question</label>
          <textarea
            maxLength={100}
            rows={4}
            value={question}
        ...
        <div className="mt-4 md:mt-0">
          <label className="block mb-2 font-medium text-textDark">Time Limit</label>
          <select
            value={duration}
      ...
      <div className="space-y-6 mb-8">
        {options.map((opt, idx) => (
          <div key={opt.id} className="flex flex-col md:flex-row md:items-center md:space-x-4">
            {/* Option Number & Text */}
